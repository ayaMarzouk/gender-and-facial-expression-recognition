...
def HOG_HOF_Features(test_dir):
    ...
    while 1:
        ...
        AllFeatures = np.hstack((featureVector, hogfeatures))
        prede = expressionHybrid.predict(AllFeatures)[0]
    ...
    print('HOG + HOF Winning expression: {} with Accuracy: {} %'.format(expressionLabels[mxIndx],round(preds[mxIndx]/totalPreds,4)*100))
    ...
    print('Winning Gender using Gender Detection Model: {} with Accuracy: {} %'.format(GenderLabels[mxIndx2],round(gpreds[mxIndx2]/totalX,4)*100))
